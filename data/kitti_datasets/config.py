...
configs.eval_ground_truth_path = '/material/data/semantic_kitti/kitti/frustum/ground_truth'
configs.eval_image_id_file_path = '/material/data/semantic_kitti/kitti/frustum/image_sets/val.txt'
